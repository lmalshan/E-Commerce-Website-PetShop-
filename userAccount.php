...
if(isset($_POST['forgotSubmit'])){
    ...
    if(!empty($_POST['email'])){
        ...
        if($prevUser > 0){
            ...
            if($update){
                $resetPassLink = 'https://forgot15.000webhostapp.com/resetPassword.php?fp_code='.$uniqidStr;
                ...
                $mailContent = 'Dear '.$userDetails['first_name'].' '.$userDetails['last_name'].', 
                ...
                //additional headers
                $headers .= 'From: CuddleCare<curddlecare@hotmail.com>' . "\r\n";
                //send email
