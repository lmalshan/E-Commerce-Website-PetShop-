...
class User{
    ...
    private $dbUsername = "id9958043_root";
    private $dbPassword = "itpdm123";
    private $dbName     = "id9958043_cuddlecaredb";
    ...
    public function __construct(){
        if(!isset($this->db)){
			...
			//$conn = mysqli_connect("localhost","id9918847_forgot","","id9918847_frgt");
